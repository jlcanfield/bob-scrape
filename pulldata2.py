...
#Data Sources
bData = pd.read_html('http://ghlea.com/JailRosters/GHBookings.html')
rData = pd.read_html('http://ghlea.com/JailRosters/GHReleases.html')
fData = pd.read_html('http://ghlea.com/JailRosters/GHRoster.html')

bHeaderslist(bData.columns.values)
